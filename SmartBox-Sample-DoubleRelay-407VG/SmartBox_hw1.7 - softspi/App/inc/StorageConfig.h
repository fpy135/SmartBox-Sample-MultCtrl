...
//用户扇区
#define USER_SECTOR_USE_LEN		(16+28+28+28+10+10+8+24+8+4)
...
#define ENERGY_PARA_ADDR		(WebUsername_ADDR + 10 + 8)			//两路电量计能4*3*2 = 24 字节
#define ENERGY_REF_ADDR			(ENERGY_PARA_ADDR + 24)		//VREF+IREF  4*2 = 8 字节

#define SENSOR_485_USE_ADDR		(ENERGY_REF_ADDR+8)			//485传感器挂载情况 4 字节
